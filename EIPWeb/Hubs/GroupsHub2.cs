...
namespace EIPWeb.Hubs
{
    ...
    public class GroupsHub2 : Hub
    {
        ...
        public void SendMessage(string room, string message)
        {
            ...
            //list.Add("");
            //Clients.Clients(list).MessageReceived(Clients.Caller, message);
        }

        //public void SendMessage(string room, Message message)
        //{
        //    Clients.All.MessageReceived(Clients.Caller, message.MessageText);
        //}
